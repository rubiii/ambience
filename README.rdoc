...
JVM-Parameters for your JRuby app.

Loads a default configuration file and merges it with all available
JVM-Parameters when running the application on JRuby.
